<div x-show="showModalEdit"
    ...
    <div class="bg-white p-6 rounded shadow-md w-full max-w-md">
        <h2 class="text-xl font-bold mb-4">Editar Adición</h2>
        <form @submit.prevent="actualizarAdicion">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select multiple x-model="form.categoria_id" class="w-full border rounded px-3 py-2">
            ...
            <div class="flex justify-end gap-2">
                <button type="button" @click="showModalEdit = false" class="px-4 py-2 bg-gray-300 rounded">Cancelar</button>
