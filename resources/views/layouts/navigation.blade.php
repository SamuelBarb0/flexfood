    ...
    <div>
        ...
        <nav x-data x-init="$watch('$store.ordenes.nuevas', value => {})" class="px-4 py-6 space-y-2 text-sm font-medium text-gray-700">
            ...
            @if(auth()->user()->hasRole(['administrador', 'mesero']))
                <!-- Analíticas -->
                <a href="{{ route('analiticas.index') }}" class="flex items-center px-4 py-2 rounded-md text-[#153958] hover:bg-[#F2F2F2]">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <!-- Historial de Mesas -->
                <a href="{{ route('historial.mesas') }}" class="flex items-center px-4 py-2 rounded-md text-[#153958] hover:bg-[#F2F2F2]">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
